...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Clareza que envolve. Resultado que permanece. Plataforma multi-cliente da Aurora para gestão financeira inteligente de pequenas e médias empresas." },
    ...
    <div className="min-h-screen" style={{ background: "var(--linen2)" }}>
      ...
      >
        <Link to="/" className="inline-flex items-center gap-2.5" style={{ color: "var(--green)" }}>
          <LogoMark size={22} />
          <span className="aurora-serif text-[17px]" style={{ color: "var(--foreground)", fontWeight: 500 }}>
            Aurora
          </span>
        </Link>
        <div className="hidden md:flex items-center gap-7">
          <a href="#solucao" className="aurora-link">Solução</a>
          <a href="#modulos" className="aurora-link">Módulos</a>
          <a href="#sobre" className="aurora-link">Sobre</a>
          <Link to="/login" className="aurora-link">Entrar</Link>
        </div>
        <Link
          to="/login"
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-end relative z-10 max-w-[1280px] mx-auto">
          ...
          <div className="pb-2">
            <p
              className="aurora-serif italic mb-7 pl-5"
            ...
            <p className="text-[14px] mb-8" style={{ color: "var(--muted-foreground)", lineHeight: 1.85 }}>
              A Aurora é uma gestora financeira boutique para PMEs. Cuidamos de tudo — da importação dos seus extratos à entrega de DFC, projeções e fechamento mensal — com tecnologia própria e atendimento humano.
            </p>
      ...
      <div className="overflow-hidden py-4" style={{ background: "var(--green)" }}>
        <div className="flex gap-12 whitespace-nowrap" style={{ animation: "aurora-mq 32s linear infinite" }}>
          {Array.from({ length: 2 }).map((_, idx) => (
            <div key={idx} className="flex gap-12">
              {["Gestão financeira", "Clareza", "DFC", "Crescimento", "PMEs", "Resultados", "Aurora"].map((t, i) => (
      ...
      <section id="solucao" className="px-8 lg:px-14 py-24 max-w-[1280px] mx-auto">
        <div className="flex items-end justify-between mb-14 flex-wrap gap-6">
          <div>
            <div className="aurora-cap mb-2.5" style={{ color: "var(--sage)" }}>[ 01 ] — Solução</div>
            <h2 className="aurora-serif" style={{ fontSize: "clamp(36px, 5vw, 64px)", lineHeight: 1, letterSpacing: "-2px" }}>
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {[
            ...
            <div key={b.n} className="aurora-card flex flex-col gap-3">
              <div className="aurora-serif" style={{ fontSize: 44, color: "var(--line)", letterSpacing: "-2px" }}>{b.n}</div>
      ...
      <section className="px-8 lg:px-14 py-20" style={{ background: "var(--linen)" }}>
        <div className="max-w-[1280px] mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h3 className="aurora-serif text-[44px]" style={{ lineHeight: 1.05, letterSpacing: "-1.5px" }}>
            ...
            <p className="mt-4 text-[13px] max-w-md" style={{ color: "var(--muted-foreground)", lineHeight: 1.8 }}>
              Já é cliente da Aurora? Entre na plataforma e acompanhe o fechamento do mês em tempo real.
            </p>
          </div>
