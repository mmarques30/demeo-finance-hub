...
export const Route = createFileRoute("/admin/importar")({
  ...
  head: () => ({ meta: [{ title: "Importar Extratos · De Meo" }] }),
});
    ...
    <AdminLayout>
      ...
      <div className="px-8 lg:px-12 pb-12 grid gap-8">
        ...
        >
          ...
          />
          <div className="dm-serif text-[32px]" style={{ color: "var(--green)", letterSpacing: "-1px" }}>↓</div>
          <div className="dm-serif text-[24px] mt-2">Arraste o extrato aqui</div>
        ...
        {files.length > 0 && (
          <div className="grid lg:grid-cols-3 gap-5">
            <div className="dm-card">
              <div className="dm-cap mb-3">Arquivos enviados</div>
            ...
            <div className="dm-card">
              <div className="dm-cap mb-3">Cliente vinculado</div>
              <select
                value={clientId}
            ...
            <div className="dm-card">
              <div className="dm-cap mb-3">Banco</div>
              <select
                value={bank}
        ...
        {stage !== "idle" && stage !== "done" && (
          <div className="dm-card flex items-center gap-4">
        ...
        {stage === "done" && (
          <div className="dm-card p-0 overflow-hidden">
            <div className="px-6 py-5 flex items-center justify-between flex-wrap gap-3" style={{ borderBottom: "1px solid var(--line)" }}>
              <div>
                <div className="dm-cap mb-1">Resultado</div>
              ...
              <thead>
                <tr style={{ background: "var(--linen)" }}>
                  ...
                  {["Data", "Descrição", "Valor", "Categoria sugerida", "Ação"].map((h) => (
                    <th key={h} className="text-left px-5 py-3 dm-cap" style={{ fontWeight: 500 }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {mockResultados.map((r, i) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3 text-[12px] dm-serif" style={{ color: r.value >= 0 ? "var(--green)" : "var(--navy)", fontSize: 14 }}>
                    ...
                    <td className="px-5 py-3 text-[11px]">
                      <span className="dm-link mr-3">Aprovar</span>
                      <span className="dm-link">Editar</span>
                    </td>
                  </tr>
                ))}
              </tbody>
